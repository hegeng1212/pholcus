...
[Pholcus](https://github.com/hegeng1212/pholcus) 用户公共维护的spider爬虫规则库。
...
- 每个规则放在单一个独的子目录
- 新增规则最好提供README.md
- 新增规则时，须在根目录 `pholcus_lib.go` 文件的import组中添加类似`_ "github.com/hegeng1212/pholcus_lib/jingdong"`的包引用声明
